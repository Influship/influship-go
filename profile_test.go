...
func TestProfileLookup(t *testing.T) {
	...
	_, err := client.Profiles.Lookup(context.TODO(), influshipapi.ProfileLookupParams{
		Profiles: []influshipapi.ProfileLookupParamsProfile{{
			Platform: "instagram",
