...
<a href="https://pkg.go.dev/github.com/stainless-sdks/influship-api-go"><img src="https://pkg.go.dev/badge/github.com/stainless-sdks/influship-api-go.svg" alt="Go Reference"></a>

<!-- x-release-please-end -->

The Influship Go library provides convenient access to the [Influship REST API](https://influship.mintlify.app)
...
```go
import (
	"github.com/stainless-sdks/influship-api-go" // imported as influshipapi
)
```
...
```sh
go get -u 'github.com/stainless-sdks/influship-api-go@v0.0.1'
```
...
The influshipapi library uses the [`omitzero`](https://tip.golang.org/doc/go1.24#encodingjsonpkgencodingjson)
...
See the [full list of request options](https://pkg.go.dev/github.com/stainless-sdks/influship-api-go/option).
...
`*influshipapi.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `influshipapi.File(reader io.Reader, filename string, contentType string)`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/influship-api-go/issues) with questions, bugs, or suggestions.
