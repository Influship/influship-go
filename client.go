...
// interacting with the Influship API. You should not instantiate this client
...
// DefaultClientOptions read from the environment (INFLUSHIP_API_KEY,
// INFLUSHIP_BASE_URL). This should be used to initialize new clients.
func DefaultClientOptions() []option.RequestOption {
	defaults := []option.RequestOption{option.WithEnvironmentProduction()}
	if o, ok := os.LookupEnv("INFLUSHIP_BASE_URL"); ok {
		defaults = append(defaults, option.WithBaseURL(o))
	}
	if o, ok := os.LookupEnv("INFLUSHIP_API_KEY"); ok {
...
// environment (INFLUSHIP_API_KEY, INFLUSHIP_BASE_URL). The option passed in as
