...
func TestUserAgentHeader(t *testing.T) {
	...
	_, _ = client.Search.New(context.Background(), influshipapi.SearchNewParams{
		Query: "fitness influencers in Los Angeles",
		Limit: influshipapi.Int(10),
	})
	if userAgent != fmt.Sprintf("Influship/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Search.New(context.Background(), influshipapi.SearchNewParams{
		Query: "fitness influencers in Los Angeles",
		Limit: influshipapi.Int(10),
	})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Search.New(cancelCtx, influshipapi.SearchNewParams{
		Query: "fitness influencers in Los Angeles",
		Limit: influshipapi.Int(10),
	})
	if err == nil {
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Search.New(deadlineCtx, influshipapi.SearchNewParams{
			Query: "fitness influencers in Los Angeles",
			Limit: influshipapi.Int(10),
		})
		if err == nil {
